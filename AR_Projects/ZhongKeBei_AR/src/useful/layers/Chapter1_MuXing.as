package useful.layers
{
	...
	import useful.layers.lyrics.MuXingMp3Lyric;
	
	public class Chapter1_MuXing extends Sprite
	{
		...
		public var muXing:Sphere;
		
		private var muXingMp3Lyric:MuXingMp3Lyric;
		
		public function Chapter1_MuXing(flarManager:FLARManager, viewportSize:Rectangle)
		{
		...
		public function addMarker (marker:FLARMarker) :void {
			...
			muXing = new Sphere(160, 50, 50, false, new TextureMaterial(new EmbedManager.MuXingImage().bitmapData));
			muXing.rotationX = 90 * Math.PI / 180;
			container.addChild(muXing);
			
			try
			{
				getChildIndex(muXingMp3Lyric);
			}
			catch(error:ArgumentError)
			{//!!!!!!!!!!!!!!!!!
				muXingMp3Lyric = new MuXingMp3Lyric();
				addChild(muXingMp3Lyric);
			}
		...
		public function removeMarker (marker:FLARMarker) :void {
			...
			try
			{
				...
				removeChildAt(getChildIndex(muXingMp3Lyric));
				muXingMp3Lyric = new MuXingMp3Lyric();
			}
			catch(error:ArgumentError)
			{
