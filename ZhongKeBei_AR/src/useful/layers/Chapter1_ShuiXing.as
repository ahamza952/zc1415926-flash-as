package useful.layers
{
	...
	import useful.layers.lyrics.ShuiXingMp3Lyric;
	
	public class Chapter1_ShuiXing extends Sprite
	{
		...
		public var shuiXing:Sphere;
		
		private var shuiXingMp3Lyric:ShuiXingMp3Lyric;
		
		public function Chapter1_ShuiXing(flarManager:FLARManager, viewportSize:Rectangle)
		{
		...
		public function addMarker (marker:FLARMarker) :void {
			...
			shuiXing = new Sphere(100, 20, 20, false, new TextureMaterial(new EmbedManager.ShuiXingImage().bitmapData));
			shuiXing.rotationX = 90 * Math.PI / 180;
			container.addChild(shuiXing);
			
			try
			{
				getChildIndex(shuiXingMp3Lyric);
			}
			catch(error:ArgumentError)
			{//!!!!!!!!!!!!!!!!!
				shuiXingMp3Lyric = new ShuiXingMp3Lyric();
				addChild(shuiXingMp3Lyric);
			}
		...
		public function removeMarker (marker:FLARMarker) :void {
			...
			try
			{
				...
				removeChildAt(getChildIndex(shuiXingMp3Lyric));
				shuiXingMp3Lyric = new ShuiXingMp3Lyric();
			}
			catch(error:ArgumentError)
			{
		...
		private function onEnterFrame (evt:Event) :void {
			...
			/*if(this.earth != null)
			earth.rotationY -= 0.1;*/
			if(this.shuiXing != null)
				shuiXing.rotationY -= 0.1;
