package useful.layers
{
	...
	import useful.layers.lyrics.JinXingMp3Lyric;
	
	public class Chapter1_JinXing extends Sprite
	{
		...
		public var jinXing:Sphere;
		
		private var jinXingMp3Lyric:JinXingMp3Lyric;

		
		public function Chapter1_JinXing(flarManager:FLARManager, viewportSize:Rectangle)
		{
		...
		public function addMarker (marker:FLARMarker) :void {
			...
			jinXing = new Sphere(100, 20, 20, false, new TextureMaterial(new EmbedManager.JinXingImage().bitmapData));
			jinXing.rotationX = 90 * Math.PI / 180;
			container.addChild(jinXing);
			
			try
			{
				getChildIndex(jinXingMp3Lyric);
			}
			catch(error:ArgumentError)
			{//!!!!!!!!!!!!!!!!!
				jinXingMp3Lyric = new JinXingMp3Lyric();
				addChild(jinXingMp3Lyric);
			}
		...
		public function removeMarker (marker:FLARMarker) :void {
			...
			try
			{
				...
				removeChildAt(getChildIndex(jinXingMp3Lyric));
				jinXingMp3Lyric = new JinXingMp3Lyric();
			}
			catch(error:ArgumentError)
			{
		...
		private function onEnterFrame (evt:Event) :void {
			...
			/*if(this.earth != null)
			earth.rotationY -= 0.1;*/
			if(this.jinXing != null)
				jinXing.rotationY -= 0.1;
