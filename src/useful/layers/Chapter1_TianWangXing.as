package useful.layers
{
	...
	import useful.layers.lyrics.TianWangXingMp3Lyric;
	
	public class Chapter1_TianWangXing extends Sprite
	{
		...
		public var tianWangXing:Sphere;
		
		private var tianWangXingMp3Lyric:TianWangXingMp3Lyric;
		
		public function Chapter1_TianWangXing(flarManager:FLARManager, viewportSize:Rectangle)
		{
		...
		public function addMarker (marker:FLARMarker) :void {
			...
			tianWangXing = new Sphere(100, 20, 20, false, new TextureMaterial(new EmbedManager.TianWangXingImage().bitmapData));
			tianWangXing.rotationX = 90 * Math.PI / 180;
			container.addChild(tianWangXing);
			
			try
			{
				getChildIndex(tianWangXingMp3Lyric);
			}
			catch(error:ArgumentError)
			{//!!!!!!!!!!!!!!!!!
				tianWangXingMp3Lyric = new TianWangXingMp3Lyric();
				addChild(tianWangXingMp3Lyric);
			}
		...
		public function removeMarker (marker:FLARMarker) :void {
			...
			try
			{
				...
				removeChildAt(getChildIndex(tianWangXingMp3Lyric));
				tianWangXingMp3Lyric = new TianWangXingMp3Lyric();
			}
			catch(error:ArgumentError)
			{
		...
		private function onEnterFrame (evt:Event) :void {
			...
			/*if(this.earth != null)
			earth.rotationY -= 0.1;*/
			if(this.tianWangXing != null)
				tianWangXing.rotationY -= 0.1;
